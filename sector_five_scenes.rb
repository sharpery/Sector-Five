...
class SectorFive < Gosu::Window
  ...
  def draw_end
    ...
    @message_font.draw(@message, 40,75,1,1,1,Gosu::Color::FUCHSIA)
  ...
  def initialize_game
    ...
    @bullets = []
    @explosions = []
    @scene = :game #change from update/draw_start to update/draw_game
    @enemies_appeared = 0
    @enemies_destroyed = 0
  ...
  def initialize_end(fate)
    ...
    when :off_top
      ...
      @message2 = "Before you were destroyed, "
      @message2 += "you took out #{@enemies_destroyed} enemy ships."
    end
